...
<!-- Mirrored from wallsproperty.netlify.app/listing-style-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Aug 2022 11:59:02 GMT -->
                ...
                <div class="collapse navbar-collapse" id="main_nav99">
                    <ul class="navbar-nav mx-auto ">
                        <li class="nav-item dropdown">
                            <a class="nav-link active dropdown-toggle" href="#" data-toggle="dropdown"> Início </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"> Pages </a>
                            <ul class="dropdown-menu animate fade-up">

                                <li><a class="dropdown-item icon-arrow" href="#"> Green Propriety </a>
